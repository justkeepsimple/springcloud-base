...
public final class RegexUtil {
    ...
    /**
     身份证校验(15位纯数字，18位纯数字或者17位数字加上最后一位大写X
     **/
    public static final String REG_MATCH_IDCARD="^(\\d{15}$|^\\d{18}$|^\\d{17}(\\d|X))$";
     ...
     * 移动电话
     */
    public static final String REG_MOBILE_TELEPHONE = "^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|17[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\\d{8}$";
    /**
    ...
    /**
     * 正则表达式:一般网站的密码 包括以下四类字符中的至少两类： 数字/小写字母/大写字母/其他字符  6-24位
     * ((?=.*\\d) 断言任意数字
     */
    //public static final String REG_PASSWORD_COMMON = "(?=^.{6,24}$)((?=.*\\d)((?=.*[A-Z])|(?=.*[a-z])|(?=.*[^A-Za-z0-9]))|(?=.*[A-Z])((?=.*\\d)|(?=.*[a-z])|(?=.*[^A-Za-z0-9]))|(?=.*[a-z])((?=.*[A-Z])|(?=.*\\d)|(?=.*[^A-Za-z0-9]))|(?=.*[^A-Za-z0-9])((?=.*[A-Z])|(?=.*[a-z])|(?=.*\\d)))^.*";
     ...
     *  6位支付密码正则
     */
    public static final String REG_PASSWORD_PAY = "\\d{6}";
